...
<section id="jumbotron-interna" class="jumbotron-productos text-white">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0">
                    <?php the_title(); ?>
                </h1>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-lg-3 mb-4 text-start">
                <h3 class="text-primary mb-3" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    Categorías
                </h3>
                <select class="form-select d-lg-none" aria-label="Default select example"
                    onchange="location = this.value;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                ...
                <ul class="d-none d-lg-block" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    <?php if (
                        !empty($product_categories) &&
                        !is_wp_error($product_categories)
                    ) {
