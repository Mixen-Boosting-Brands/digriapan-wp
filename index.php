...
<section id="proveedores" class="text-white py-60">
    <div class="overlay"></div>
    <div class="container">
        <div class="row mb-5">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-6 col-md-4 col-lg-2 mb-3 my-lg-auto">
                <figure
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="100"
        ...
        <div class="row">
            <div class="col">
                <a
                    ...
                    data-aos-delay="600"
                >
                    Conoce nuestras líneas de producto</a
                >
            </div>
        </div>
    </div>
...
<section id="video" class="text-white pt-30 pb-60">
    <div id="cuchara" class="elemento-parallax"></div>
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-4 text-lg-end">
                <div
        ...
        <div class="row blog-row">
            <div class="col-lg-6">
                <div
                    ...
                    data-aos-delay="0"
                >
                    <!-- Contenido del elemento principal -->
                    <div class="overlay"></div>
                    <p>
                        <a href="#">Blog</a>
                    </p>
                    <a href="#">
                        <h1>
                            El ingrediente secreto para un éxito en la
                            repostería: La calidad en tus insumos
                        </h1>
                    </a>
                    <p>
                        Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Sequi ut magnam perferendis
                        mollitia dolores odit distinctio ea a corporis?
                        Fuga accusantium eius ad? Ipsa non doloremque
                        quas provident, eum error!
                    </p>
                    <a
                        href="#"
                        class="btn btn-primary btn-lg rounded-pill"
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-12">
                        <div
                            class="blog-secondary-item blog-secondary-item-sin-overlay"
                            data-aos="fade-up"
                            data-aos-duration="1000"
                            data-aos-delay="100"
                        >
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        >
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Sequi ut magnam
                                perferendis mollitia dolores odit
                                distinctio ea a corporis?
                            </p>
                            <a
                                href="#"
